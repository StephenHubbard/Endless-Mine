...
namespace ES3Types
{
	...
	public class ES3UserType_Animator : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WriteProperty("updateMode", instance.updateMode);
			...
			writer.WriteProperty("cullingMode", instance.cullingMode);
			...
			writer.WriteProperty("keepAnimatorControllerStateOnDisable", instance.keepAnimatorControllerStateOnDisable, ES3Type_bool.Instance);
