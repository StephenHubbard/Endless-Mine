...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("position", "rotation", "velocity", "angularVelocity", "useAutoMass", "mass", "sharedMaterial", "centerOfMass", "inertia", "drag", "angularDrag", "gravityScale", "bodyType", "useFullKinematicContacts", "isKinematic", "freezeRotation", "constraints", "simulated", "interpolation", "sleepMode", "collisionDetectionMode", "name")]
	public class ES3UserType_Rigidbody2D : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WriteProperty("bodyType", instance.bodyType);
			...
			writer.WriteProperty("sleepMode", instance.sleepMode);
